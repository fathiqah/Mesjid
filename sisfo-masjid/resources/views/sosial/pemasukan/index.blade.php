...
<div class="container-fluid px-4">
    ...
    <div class="mt-4 h1"><span>Pemasukan Sosial</span>
        @if (auth()->user()->roles == 'bendahara')
        <button data-bs-toggle="modal" data-bs-target="#tambah" type="button" class="btn btn-primary float-end">
            <i class="fas fa-plus"></i> Tambah
        </button>
        @endif
    </div>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item">Sosial</li>
        ...
        <div class="modal-content">
            <form action="" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahLabel">Tambah Pemasukan Sosial</h5>

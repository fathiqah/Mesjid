...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ asset('landing_page_assets/assets/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('landing_page_assets/assets/vendor/purecounter/purecounter_vanilla.js') }}"></script>
    ...
    <script src="{{ asset('landing_page_assets/assets/vendor/swiper/swiper-bundle.min.j') }}s"></script>
